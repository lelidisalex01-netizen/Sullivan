...
st.set_page_config(page_title="Sullivan V22.0.6", page_icon="S", layout="wide")
...
st.markdown("<div class=\"v15-topbrand\">Sullivan <span>Business Command Center · V22.0.6</span></div>",unsafe_allow_html=True)
...
st.markdown(r"""
<style>
/* V22.0.6: own the visible select chevron instead of relying on BaseWeb's SVG. */
...
# V22.0.6 — force Streamlit/BaseWeb select chevrons to contrast with
...
# ============================================================
# V22.0.6 — GLOBAL COUNTRY + TAX-REGION ARCHITECTURE
    ...
    if not settings_user:
        ...
        with pref_tab:
            ...
            if st.button("Save tax region", type="primary", key="v204_save_region"):
                ...
                st.rerun()
            st.caption(
                "V22.0.6 recognizes ISO countries/territories and available first-level regions globally. "
